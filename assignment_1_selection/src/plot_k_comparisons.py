...
plt.plot(k_values, quickselect_avg_by_k.values, label='QuickSelect Mean Comparisons', marker='o', color='red',
		 markersize=3, linestyle='None')
plt.plot(k_values, lazyselect_avg_by_k.values, label='LazySelect Mean Comparisons', marker='o', color='orange',
		 markersize=3, linestyle='None')
