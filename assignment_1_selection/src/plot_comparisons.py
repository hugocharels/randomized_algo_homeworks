...
plt.plot(
    list_sizes,
    quickselect_avg.values,
    label="QuickSelect Empirical",
    marker="o",
    color="red",
)
plt.plot(
    list_sizes,
    lazyselect_avg.values,
    label="LazySelect Empirical",
    marker="s",
    color="orange",
)
...
plt.plot(
    list_sizes,
    quickselect_expected,
    label="QuickSelect Expected 2(1+ln2)n",
    linestyle="--",
    color="red",
)
...
plt.title(
    "Number of Comparisons vs List Size for QuickSelect and LazySelect (Empirical vs Expected)"
)
plt.legend()
